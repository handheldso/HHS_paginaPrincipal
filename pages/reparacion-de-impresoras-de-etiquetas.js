  ...
  return (
    <div className="ya">
      <Head>
        <html lang="es" />
        <title>
          Impresoras de Etiquetas | Reparación de Impresoras Industriales Zebra
          | Mantenimiento de Impresoras Honeywell
        </title>
        <meta
          name="description"
          content="Reparación de Impresoras Industriales de Etiquetas. ¡Primero le Reparamos y Entregamos sus Equipos y Después Realizará el Pago! Mantenimiento Correctivo y Preventivo de Impresoras Térmicas. ¡Diagnostico Sin Costo! Contamos con Pólizas de Reparación Para Asegurar el Funcionamiento de sus Equipos. ¡Recolección y Entrega de sus Impresoras Sin Costo!"
        />
        <link rel="shortcut icon" href="/logo-copia.png" />
        <meta
          name="keywords"
          content="Reparación, servicio técnico, mantenimiento, diagnóstico, mantenimiento preventivo, mantenimiento correctivo, impresora industrial, impresora móvil, impresora portátil, impresora de escritorio, impresora de credenciales, zebra, Honeywell, intermec, symbol, motorola, impresoras térmicas"
        />
        <meta name="robots" content="index,follow,all" />
        <meta
          property="og:title"
          content="Impresoras de Etiquetas | Reparación de Impresoras Industriales Zebra | Mantenimiento de Impresoras Honeywell"
        />
        <meta
          property="og:image"
      ...
      <ContenedorFlexa>
        <IconosReparacionGeneral
          ...
          nuevem="¿Necesita un plan de renta para impresoras?."
          diezm="¡Conozca nuestro servicio de Renta!"
          oncem="Adquiera las impresoras que mejor se adapten a sus
        necesidades."
      ...
      <ContenedorBotona>
        <BotonesMovilCinco
          muno="¿Necesita un plan de renta para impresoras?."
