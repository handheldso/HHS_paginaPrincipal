  ...
  return (
    <div className="ya">
      <Head>
        <html lang="es" />
        <title>
          Hand held para Inventarios | Renta de PDA | Arrendamiento de HandHelds
          | Terminales Portátiles
        </title>
        <meta
          name="description"
          content="Renta de Equipos Handheld ¡Sin Plazos Forzosos ni penalizaciones!, Crédito Inicial y Esquemas de Pagos. Arrendamiento de PDA 100% Deducible de Impuestos. Contamos con Alquiler de Equipos Handhelds de las marcas, Motorola, Zebra, Honeywell e Intermec. ¡Reparaciones sin costo adicional!"
        />
        <link rel="shortcut icon" href="/logo-copia.png" />
        <meta
          name="keywords"
          content="Renta, arrendamiento, alquiler, leasing, handheld, hand held, PDA, terminal portátil, motorola, Honeywell, zebra, intermec, symbol, lector de códigos de barras"
        />
      ...
      <ContenedorFlexa>
        <IconosRentaGeneral
          ...
          ochom="¿Necesita dar mantenimiento a sus handhelds?"
