  ...
  return (
    <div className="ya">
      <Head>
        <html lang="es" />
        <title>
          Reparación de Lectores De Códigos de Barras | Mantenimiento de
          Lectores Honeywell y Zebra | Escáneres de Códigos de Barras
        </title>
        <meta
          name="description"
          content="Reparación de Lectores de Códigos de Barras, Mantenimiento de Lectores QR. ¡Diagnostico Sin Costo y con Atención en Sitio! Proporcionamos Equipos de Respaldo para que Continúe con sus Operaciones en Lo que sus Equipos son Reparados. ¡Llame Ahora!"
        />
        <meta
          name="keywords"
          content="Reparación, servicio técnico, mantenimiento, diagnóstico, mantenimiento preventivo, mantenimiento correctivo, scanner, lector de códigos, escáner, códigos de barras, honeywell, symbol, motorola, intermec, zebra, códigos qr, lector inalámbrico"
        />
        <meta name="robots" content="index,follow,all" />
        <link rel="shortcut icon" href="/logo-copia.png" />
        <meta
          property="og:title"
          content="Reparación de Lectores De Códigos de Barras | Mantenimiento de Lectores Honeywell y Zebra | Escáneres de Códigos de Barras"
        />
        <meta
          property="og:image"
      ...
      <ContenedorFlexa>
        <IconosReparacionGeneral
          ...
          nuevem="¿Necesita un plan de renta para lectores?."
      ...
      <ContenedorBotona>
        <BotonesMovilCinco
          muno="¿Necesita un plan de renta para lectores?."
