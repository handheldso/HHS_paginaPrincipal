...
import RentaL from "../components/pestanas/RentaL";
  ...
  return (
    <div className="ya">
      <Head>
        <html lang="es" />
        <title>
          Renta de Lectores de Códigos de Barras | Lectores de Códigos QR |
          Alquiler de Escáneres
        </title>
        <meta
          name="description"
          content="Renta de Scanners de Códigos de Barras. ¡Crédito Inicial y Esquemas de Pagos!, Alquiler de Lectores Inalámbricos y Alámbricos Zebra y Honeywell. Garantizamos que los equipos se adapten a sus necesidades. ¡Equipo Demo Sin costo para Pruebas en sus Instalaciones!"
        />
        <link rel="shortcut icon" href="/logo-copia.png" />
        <meta
          name="keywords"
          content="Renta, arrendamiento, alquiler, leasing, lector de códigos, scanner, escáner, códigos de barras, Honeywell, symbol, motorola, intermec, zebra, códigos qr, lector inalámbrico"
        />
        <meta name="robots" content="index,follow,all" />
        <meta
          property="og:title"
          content="Renta de Lectores de Códigos de Barras | Lectores de Códigos QR | Alquiler de Escáneres"
        />
        <meta
          property="og:image"
      ...
      <ContenedorFlexa>
        <IconosRentaGeneral
          ...
          ochom="¿Necesita dar mantenimiento a sus lectores?."
          nuevem="¡Conozca nuestro servicio de Reparación!"
          diezm="Adquiera los lectores que mejor se adapten a sus necesidades."
