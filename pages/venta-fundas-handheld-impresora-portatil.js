...
import FundasTitulo from "../components/pestanas/FundasTitulo";
import Form from "../components/pestanas/Form";
import TextoFundas from "../components/pestanas/TextoFundas";
  ...
  return (
    <>
      <Head>
        <html lang="es" />
        <title>
          Venta de Fundas para Handheld | Fundas para Impresoras Portátiles |
          Fundas a la Medida para Terminales Portátiles.
        </title>
        <meta
          name="description"
          content="Somos Fabricantes de las Mejores Fundas para Handheld, PDA, Terminales Portátiles, Impresoras de Etiquetas, Lectores de Códigos, Proteja sus Equipos con Fundas Diseñadas a la Medida de cada Marca y Modelo. Fabricadas con Materiales de Calidad para Cumplir con sus Necesidades."
        />
        <link rel="shortcut icon" href="/logo-copia.png" />
        <meta
          name="keywords"
          content="Fundas. Protección, Handheld, PDA, Terminal Portátil, Hand Held, Impresora Portátil, Impresora de Etiquetas, Lector de códigos, Escáner de Códigos, Scanner de Códigos, Zebra, Honeywell, Intermec, Symbol, Motorola, Seguridad, Protectora, Impresora Térmica, Marcas, Modelos."
        />
        <meta name="robots" content="index,follow,all" />
        <meta
          property="og:title"
          content="Software HHS | Venta en ruta | Implementación para Hand Held | Control de Inventario"
        />
        <meta
          property="og:image"
        ...
        <meta
          ...
          content="Somos Fabricantes de las Mejores Fundas para Terminales Portátiles e Impresoras de Etiquetas, Proteja sus Equipos con Fundas Diseñadas a la Medida de cada Marca y Modelo. Fabricadas con Materiales de Calidad para Cumplir con sus Necesidades."
        />
