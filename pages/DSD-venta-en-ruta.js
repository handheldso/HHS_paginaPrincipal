  ...
  return (
    <>
      <Head>
        <html lang="es" />
        <title>
          DSD Venta en Ruta | Software para Control de Inventario | Aplicación
          para Hand Held | Sistema para Gestión de Pedidos.
        </title>
        <meta
          name="description"
          content="Solución DSD para venta en ruta y reparto. Aplicación para Handhelds que le Permitirá Tener Control de Su Inventario.  Software Adecuado para Toma de Pedidos en Ruta. Sistema Especializado de Venta al Detalle para Equipos Hand Held, con Sistema Operativo Android."
        />
        <link rel="shortcut icon" href="/logo-copia.png" />
        <meta
          name="keywords"
          content="Control de Inventario, Aplicación Móvil, App, Venta en Ruta, DSD, Direct Store Delivery, Solución, Handheld, PDA, Terminal Portátil, Software, Sistema de Punto de Venta, Toma de Pedidos, Fuerza de Ventas, Venta al detalle, Programación de Visitas, Proceso de Ruta, Dispositivos móviles e Implementación."
        />
