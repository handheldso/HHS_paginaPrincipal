    ...
    <>
      <TitImgDiv>
        <MitadIzq>
          ...
          <RDHDiv>
            <RDHTit>Venta de Handhelds</RDHTit>
            <ServicioDiv>
              <div className="sd">
                <ServicioDivTxt>
                  Venta de equipos Honeywell, Zebra, Intermec, Symbol y
                  Motorola.
                  <br />
                  Beneficios:
                </ServicioDivTxt>
        ...
        <MitadDer>
          <IMG
            src="/img/VENTA HANDHELD.webp"
            alt="Venta de Handhelds"
          />
        </MitadDer>
      </TitImgDiv>
    </>
