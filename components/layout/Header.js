  ...
  return(
    ...
    <header id="header">
      <nav className={` nav_redes navbar navbar-expand-lg bg-dark border-bottom border-body nav_redes nav_donw`}>
        ...
        <a  type="button" class="btn btn-outline-light navbar-brand col-12 order-sm-12 order-lg-0 col-lg-2 col-xl-2 order-12 order-lg-0 tel" href="tel:+525551156043" >
          <ImgBandera
            className={``}
    ...
    <nav className={`navbar navbar-expand-lg bg-body-tertiary navbarmenu nav_menu nav_contacto d-sm-block d-none`} id="nav_menu">
      <div className="container-fluid ">
